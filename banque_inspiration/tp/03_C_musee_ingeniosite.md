...
Le compte-rendu doit avoir un **titre**. Le propos doit être bien structuré (en **paragraphes**) avec une **introduction** qui présente l'intervenant et le thème de sa conférence. Puis, quelques-unes des grandes idées partagées sont expliquées dans le **développement**. Soyez spécifique en nommant les informations qui vous ont semblées importantes et en donnant des exemples des éléments qui vous ont inspirés .  Enfin, votre **conclusion** partagera une appréciation de la conférence, appréciation qui sera appuyée d'une justification (le pourquoi) et concernera des aspects précis. Il est important de conserver une attitude ouverte et respectueuse et professionelle dans cette partie du compte-rendu. 
